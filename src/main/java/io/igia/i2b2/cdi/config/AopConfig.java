...
public class AopConfig {
    ...
    @Pointcut(
        "within(within(@org.springframework.stereotype.Repository *)"
    )
    public void serviceAndDaoClassesPointcut() {
        // repository pointcut
    }
    ...
    public Advisor performanceMonitorAdvisor() {
        ...
        pointcut.setExpression("io.igia.i2b2.cdi.config.AopConfig.serviceAndDaoClassesPointcut()");
