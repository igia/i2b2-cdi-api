...
public class DerivedConceptDependencyDto {
    private Integer id;
	...
	if (!(obj instanceof DerivedConceptDependencyDto)) {
	    return false;
	}
	DerivedConceptDependencyDto other = (DerivedConceptDependencyDto) obj;
	...
	return "DerivedConceptDependencyDto [id=" + id + ", derivedConceptId=" + derivedConceptId
		+ ", parentConceptPath=" + parentConceptPath + ", derivedConceptPath=" + derivedConceptPath + "]";
    }
}
